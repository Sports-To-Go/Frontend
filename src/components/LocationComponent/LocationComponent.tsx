    ...
    <>
      <div className="location-box" onClick={handleOpenModal} style={{ cursor: 'pointer' }}>
        <div className="location-image-container">
          <img src={location.image || "https://www.indfloor.ro/wp-content/uploads/2021/07/DJI_0467.jpg"} alt={`${location.name} Header`} className="location-header-image" />
        </div>
        <div className="location-content">
          ...
          <div className="location-details">
            <p><strong>Sport:</strong> {location.sport}</p>
            <p><strong>Address:</strong> {location.address}</p>
            <p><strong>Opening Time:</strong> {location.openingTime}</p>
            <p><strong>Closing Time:</strong> {location.closingTime}</p>
          </div>
        </div>
      </div>
